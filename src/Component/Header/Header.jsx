...
const Header = () => {
    ...
    return (
        <nav className='md:sticky top-0 w-full  flex items-center justify-between px-8 bg-gradient-to-r from-green-500 via-blue-500 to-indigo-600 h-16 text-white hover:text-gray-300 rounded'>
