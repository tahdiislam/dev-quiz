...
const QuizArea = () => {
    ...
    return (
        <quizContext.Provider value={{handleSetAnswer}}>
        <div>
            ...
            <div className='md:col-span-1 border sticky top-1 h-40 p-4 rounded-xl bg-indigo-100 shadow-lg'>
                ...
                <div>
                    ...
                    <h3 className='text-xl font-semibold text-red-500'>Wrong: {wrongAnswer}</h3>
                </div>
            </div>
